...
- [x] 11.4 Com confirmação, criar e enviar a tag `v0.1.0`; verificar que a release "VoxVault 0.1.0" existe com `VoxVault-0.1.0-setup.exe` e `SHA256SUMS.txt`, que a soma confere com o arquivo baixado e que as notas trazem o texto permanente.
