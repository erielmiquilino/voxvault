...
O ambiente SHALL usar um interpretador próprio, obtido durante o preparo, e MUST NOT usar, alterar ou depender de um Python instalado no sistema, nem alterar o `PATH` ou variáveis de ambiente globais.
...
- **AND** o Python existente, seus pacotes e o `PATH` permanecem inalterados
...
A desinstalação SHALL remover os arquivos do aplicativo, o ambiente de execução, o registro de início automático, os arquivos do serviço local e as preferências por usuário do VoxVault.
...
- **THEN** aplicativo, ambiente, início automático e preferências são removidos
...
- **THEN** o ambiente de execução e o início automático configurado permanecem
